...
public class BooksPageSteps {
  ...
  public void assert_book_table_not_empty(Boolean notEmpty) {
    booksPage.assertBooksTablePopulated(!notEmpty);
  }
  ...
  public void assert_new_book_is_displayed(DataTable table) {
    ...
    booksPage.assertBookExists(data.get(0).get("Title"), data.get(0).get("Year"));
  }
